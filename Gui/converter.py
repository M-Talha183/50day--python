...
# # #    l= Label(r,text="Temperature im Fahrenheit is " + str(fah))
# # #    l.pack()
# # # r =Tk()
# # # r.title("Converter")
# # # l=Label(r,text='Enter Temperature in Celsiuus')
# # # l.pack()
# # # e=Entry(r)
# # # e.pack()
...
# #    wight = int(e.get())
# #    hei = int(t.get())
# #    bmi = (wight*703) / (hei * hei)
# #    l= Label(r,text="your BMI value is" + str(bmi))
# #    l.pack()
# # r =Tk()
# # r.title("Converter")
# # l=Label(r,text='Enter the weight ')
# # l.pack()
# # e=Entry(r)
# # e.pack()


# # m=Label(r,text='Enter The height ')
# # m.pack()
# # t=Entry(r)
# # t.pack()
...
# # b =Button(r,text='Find BMI ',command=converter )
# # b.pack()
# # r.mainloop()
...
# entry = tk.Entry(root, font=("Arial", 24), bd=10, relief="sunken", justify="right", bg="#ECF0F1")
...
#     if text == "=":
#         button = tk.Button(root, text=text, font=("Arial", 18), height=2, width=4, bg="#27AE60", command=calculate)
#     elif text == "C":
#         button = tk.Button(root, text=text, font=("Arial", 18), height=2, width=4, bg="#E74C3C", command=clear)
#     else:
#         button = tk.Button(root, text=text, font=("Arial", 18), height=2, width=4, bg="#BDC3C7", command=lambda t=text: button_click(t))
